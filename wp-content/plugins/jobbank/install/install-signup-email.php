<?php
  ...
  text-align:center;
	...
	';
	update_option('jobbank_signup_email', trim($client_signup_email_template)  ); 
	$signup_subject = 'Welcome To '.get_bloginfo();
	update_option('jobbank_signup_email_subject', $signup_subject  ); 
  ...
  text-align:center;
	...
	';
	update_option('jobbank_forget_email', trim($client_forget_email_template)  ); 
	$forget_subject = 'Forget Password '.get_bloginfo();
	update_option('jobbank_forget_email_subject', $forget_subject  ); 
  ...
  text-align:center;
	...
	';
	update_option('jobbank_contact_email', trim($contact_email_template)  ); 
	$contact_subject = 'New Message '.get_bloginfo();
	update_option('jobbank_contact_email_subject', $contact_subject  ); 
// Job Apply email
  ...
  text-align:center;
	...
	';
	update_option('jobbank_apply_email', trim($apply_email_template)  ); 
	$contact_subject = 'Application For';
	update_option('jobbank_apply_email_subject', $contact_subject  ); 
...
<!DOCTYPE html>
  ...
  text-align:center;
	...
	';
	update_option('jobbank_notification_email', trim($notification_email_template)  ); 
	$contact_subject = 'Job Notification';
	update_option('jobbank_notification_email_subject', $contact_subject  ); 
