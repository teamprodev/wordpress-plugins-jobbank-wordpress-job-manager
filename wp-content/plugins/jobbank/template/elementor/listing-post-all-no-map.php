<?php
namespace Elementor;
class Jobbank_Posts_Nomap_Widget extends Widget_Base {

	public function get_name() {

		return 'jobbank_post_nomap';
	}

	public function get_title() {
		return esc_html__( 'All Listings: No Map', 'jobbank' );
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'All Listing No Map', 'jobbank' ),
		...
		$this->add_control(
			...
			[
				...
				'label_block' => true,
				'multiple'    => true,
				'options'     => ep_jobbank_post_categories2(),			
			]
		);
		$this->add_control(
			'locations',
			[
				...
				'label_block' => true,
				'multiple'    => true,
				'options'     => ep_jobbank_post_locations2(),			
			]
		);
		$this->add_control(
			'tag',
	...
	protected function render() {
		...
		$shortcode ="[jobbank_archive_grid_no_map ".$atts." ]";
...
Plugin::instance()->widgets_manager->register_widget_type( new Jobbank_Posts_Nomap_Widget );
//Post Category
function ep_jobbank_post_categories2() {
...
//Post locations
function ep_jobbank_post_locations2() {
	$jobbank_directory_url=get_option('ep_jobbank_url');
	if($jobbank_directory_url==""){$jobbank_directory_url='job';}
