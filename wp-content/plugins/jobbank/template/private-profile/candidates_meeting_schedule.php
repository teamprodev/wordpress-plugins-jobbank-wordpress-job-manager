<div class="list">
	<?php
		...
		$jobbank_candidate_reject= array(
		'relation' => 'OR',
		array(
		...
		$candidate_schedule,$jobbank_candidate_reject
		);
	?>
								...
								<div class="group-button mt-3">
									...
									<span id="shortlistmeeting<?php echo esc_attr($candidate_post_id); ?>">
										<?php
											...
											?>
											<button id="" class="btn btn-small-ar mb-2 <?php echo (get_post_meta($candidate_post_id, 'jobbank_candidate_shortlisted', true)=='yes'?' shortlisted':''); ?>" data-toggle="tooltip"  onclick="jobbank_candidate_shortlisted_delete('<?php echo esc_attr($candidate_post_id);?>','meeting')" title="<?php esc_html_e( 'Short Listed', 'jobbank' );?>" ><i class="fas fa-user-check mr-1"></i><?php esc_html_e( 'Shortlist', 'jobbank' );?></button>
											<?php
												}else{
											?>
											<button id="" class="btn btn-small-ar mb-2 <?php echo (get_post_meta($candidate_post_id, 'jobbank_candidate_shortlisted', true)=='yes'?' shortlisted':''); ?>" data-toggle="tooltip"  onclick="jobbank_candidate_shortlisted('<?php echo esc_html($candidate_post_id);?>','meeting')" title="<?php esc_html_e( 'Make Short Listed', 'jobbank' );?>" ><i class="fas fa-user-check mr-1"></i><?php esc_html_e( 'Shortlist', 'jobbank' );?></button>
											<?php
											}
										?>
									</span>
									...
									<span id="rejectmeeting<?php echo esc_attr($candidate_post_id); ?>">
										<?php
											...
											?>
											<button class="btn btn-small-ar mb-2 btn-delete  shortlisted" onclick="jobbank_candidate_reject_delete('<?php echo esc_attr($candidate_post_id);?>','meeting')" data-toggle="tooltip" title="<?php esc_html_e( 'Undo Reject', 'jobbank' );?>"><i class="fas fa-user-times mr-1"></i><?php esc_html_e( 'Reject', 'jobbank' );?></button>
											<?php
												}else{
											?>
											<button class="btn btn-small-ar mb-2 btn-delete " onclick="jobbank_candidate_reject('<?php echo esc_attr($candidate_post_id);?>','meeting')" data-toggle="tooltip" title="<?php esc_attr_e( 'Make Reject', 'jobbank' );?>"><i class="fas fa-user-times mr-1"></i><?php esc_html_e( 'Reject', 'jobbank' );?></button>
											<?php
											}
										?>
									</span>											
