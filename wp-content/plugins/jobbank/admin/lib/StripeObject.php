...
class StripeObject implements \ArrayAccess, \Countable, \JsonSerializable
{
    ...
    public function __set($k, $v)
    {
        ...
        if ($v === "") {
            throw new Exception\InvalidArgumentException(
                ...
                .'You may set obj->'.$k.' = NULL to delete the job'
            );
        }
    ...
    public function &__get($k)
    {
        ...
        if (!empty($this->_values) && array_key_exists($k, $this->_values)) {
            ...
            $message = "Stripe Notice: Undefined job of $class instance: $k. "
            ...
            $class = get_class($this);
            Stripe::getLogger()->error("Stripe Notice: Undefined job of $class instance: $k");
            return $nullval;
        }
    }
    ...
    public function serializeParamsValue($value, $original, $unsaved, $force, $key = null)
    {
        ...
        //
        // We throw an error if a job was set explicitly but we can't do
        ...
        if ($value === null) {
            ...
            if (!$unsaved) {
                ...
                throw new Exception\InvalidArgumentException(
                    "Cannot save job `$key` containing an API resource of type " .
