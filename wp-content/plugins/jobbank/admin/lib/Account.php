 ...
 * @job string $id
 * @job string $object
 * @job mixed|null $business_profile
 * @job string|null $business_type
 * @job mixed $capabilities
 * @job bool $charges_enabled
 * @job mixed $company
 * @job string $country
 * @job int $created
 * @job string $default_currency
 * @job bool $details_submitted
 * @job string|null $email
 * @job \Stripe\Collection $external_accounts
 * @job mixed $individual
 * @job \Stripe\StripeObject $metadata
 * @job bool $payouts_enabled
 * @job mixed $requirements
 * @job mixed|null $settings
 * @job mixed $tos_acceptance
 * @job string $type
 *
 * @package Stripe
 */
class Account extends ApiResource
{
     ...
     * capabilities job which is a hash and not the sub-list of capabilities.
     */
