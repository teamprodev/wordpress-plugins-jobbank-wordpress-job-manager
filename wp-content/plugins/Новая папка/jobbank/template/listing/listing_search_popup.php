<?php	
	...
	wp_enqueue_style('jobbank_search-popup', ep_jobbank_URLPATH . 'admin/files/css/search-form-popup.css');
...
<div class="bootstrap-wrapper" >
	<div class="modal-header mb-3">
		<h5 class="modal-title"><?php  esc_html_e('Filters','jobbank'); ?></h5>
		<button type="button" class="close" onclick='parent.jQuery.colorbox.close(); return false;'>
			<span aria-hidden="true">&times;</span>
		</button>
	</div>				
	<form class="p-2 mt-2  " id="jobbank_search_form" name="jobbank_search_form" action="<?php echo esc_url($form_action) ; ?>" >						
		<div class="form-row  " >
					...
					foreach($active_search_fields  as $field_key => $field_value){
						if($field_key!=''){
							...
							if($field_value=='text-field'){
								...
								?>
								<div class="form-group col-md-6 my-0  p-2 py-0 " >
									<input type="text" class="form-control form-control-sm 40" name="sf<?php echo esc_attr($field_key); ?>" id="<?php echo esc_attr($field_key); ?>id" placeholder="<?php echo esc_attr(ucfirst(str_replace('_',' ',$field_key))); ?>" value="<?php echo esc_attr($submit_value); ?>">
								</div>	
								<?php
								}
							}										
							...
							<div class="form-group col-md-6 my-0  p-2 py-0 " >
								<input type="text" class="form-control form-control-sm 40 searchdate"  name="sf<?php echo esc_attr($field_key); ?>" id="<?php echo esc_attr($field_key); ?>id" placeholder="<?php echo esc_attr(ucfirst(str_replace('_',' ',$field_key))); ?>" value="<?php echo esc_attr($submit_value); ?>">
							</div>										
							<?php
							}
		...
		<div class="modal-footer mt-3">							 
			<a id="reset"  class="btn btn-sm btn-block text-left  col-md-8 "><i class="fa fa-refresh p-2 " aria-hidden="true"></i><?php  esc_html_e('Reset','jobbank');?></a>
			<button type="submit" class="  pull-right col-md-4 btn btn-big "><?php  esc_html_e(' Search ','jobbank');?></button>
		</div>
	</form>
</div>
<?php
