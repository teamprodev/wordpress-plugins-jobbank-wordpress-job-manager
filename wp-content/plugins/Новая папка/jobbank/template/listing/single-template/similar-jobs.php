<?php
	...
	if(!isset($single_page_icon_saved)){$single_page_icon_saved=get_option('jobbank_single_icon_saved' );}
...
<div class="sidebar-border">
	<div class="toptitle mb-3"><?php esc_html_e('Recent Job', 'jobbank'); ?></div>
	<?php
		if ( ! empty( $jobbank_similar ) ) {	
			...
			<div class="row  card-list-4  " >
				...
				<div class="col-md-9 col-9 mt-3">
					...
					<div class="mt-0 ml-2"><span class="card-briefcase"><?php
						...
						<div class="row mt-2 ">
							<div class="col-6 ">
								<h6 class="card-price ml-2"><?php echo esc_attr(get_post_meta($listing_sm->ID,'salary', true)); ?></h6>
							</div>
							<?php
