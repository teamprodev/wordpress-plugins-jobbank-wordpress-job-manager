...
namespace Elementor;
use WP_Query;
class Jobbank_Recent_Posts_Widget extends Widget_Base {

	public function get_name() {

		return 'jobbank_recent_post';
	}

	public function get_title() {
		return esc_html__( 'All Listings + Map', 'jobbank' );
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'All Listing: Right Map', 'jobbank' ),
		...
		$this->add_control(
			...
			[
				...
				'label_block' => true,
				'multiple'    => true,
				'options'     => ep_jobbank_post_categories(),			
			]
		);
		$this->add_control(
			'locations',
			[
				...
				'label_block' => true,
				'multiple'    => true,
				'options'     => ep_jobbank_post_locations(),			
			]
		);
		$this->add_control(
			'tag',
	...
	protected function render() {
		...
		$shortcode ="[jobbank_archive_grid ".$atts." ]";		
...
Plugin::instance()->widgets_manager->register_widget_type( new Jobbank_Recent_Posts_Widget );
//Post Category
function ep_jobbank_post_categories() {
...
//Post locations
function ep_jobbank_post_locations() {
	$jobbank_directory_url=get_option('ep_jobbank_url');
	if($jobbank_directory_url==""){$jobbank_directory_url='job';}
