...
<div class="card col-md-12">
		...
		<div class="row">
			<div class="col-md-12">
			<h4>
				<?php  esc_html_e('Create Package / Membership Level','jobbank'); ?> <br /><small> &nbsp;</small> </h4>
			</div>							
		</div> 
		<form id="package_form_iv" name="package_form_iv" class="form-horizontal" role="form" onsubmit="return false;">
			<div class="form-group row">
				...
				<div class="col-md-6">
					<input type="text" class="form-control" name="package_name" id="package_name" placeholder="<?php esc_html_e('Enter Package Name','jobbank');  ?> ">
				</div>
			</div>
			<div class="form-group row">
				...
				<div class="col-md-6">
					...
					name="package_subtile" id="package_subtile" value="" placeholder="<?php esc_html_e('Enter Package Subtitle','jobbank'); ?>">
				</div>
			</div>
			<div class="form-group row">
			...
			<div class="form-group row">
				...
				<div class="col-md-6 ">
					<label>
						<input type="text" class="form-control" id="package_order" name="package_order" placeholder="<?php esc_html_e('Enter order number e.g. 1','jobbank'); ?>">
					</label>
				</div>
			</div>
			...
			<div class="form-group row">
				...
				<div class="col-md-6 ">
					<label>
						<input type="text" class="form-control" id="max_pst_no" value="" name="max_pst_no" placeholder="<?php esc_attr_e('Enter only number e.g. 1','jobbank'); ?>">
					</label>
				</div>
			</div>
			<div class="form-group row">
				...
				<div class="col-md-6 ">
					<label>
						<input type="checkbox" name="listing_feature" id="listing_feature"  value='yes'><?php  esc_html_e('Will Add On Featured List (show on top)','jobbank'); ?>
					</label>								 										
				</div>																
			</div>
			...
			<div class="form-group row">
				...
				<div class="col-md-6">
					<input type="text" class="form-control" id="package_cost" name="package_cost" placeholder="<?php esc_attr_e('Enter Initial Payment','jobbank');  ?>">
					<?php  esc_html_e('The initial amount collected at user registration.','jobbank'); ?>
				</div>
			</div>
			<div class="form-group row">
			...
			<div class="form-group row">
				...
				<div class="col-md-6 ">
					<label>
						<input type="checkbox" name="package_recurring" id="package_recurring" value="on" > <?php  esc_html_e('Enable Recurring Payment','jobbank'); ?>
					</label>
				</div>								
			</div>
			<div id="recurring_block" class="none" >
				<?php
					if(get_option('jobbank_payment_gateway')=='stripe55555'){
					?>	
					<div class="form-group row">
						<label for="text" class="col-md-2 control-label"><?php esc_html_e('Stripe Plan Name(not ID)','jobbank');?></label>
						<div class="col-md-2">
							<input type="text" class="form-control" value="" name ="jobbank_stripe_plan" id="jobbank_stripe_plan" >
						</div>
				...
				<div class="form-group row">
					...
					<div class="col-md-2">
						<input type="text" class="form-control" name ="package_recurring_cost_initial" id="package_recurring_cost_initial" placeholder="<?php esc_html_e('Amount','jobbank');?>">
					</div>
					<label for="text" class="col-md-1 control-label"><?php  esc_html_e('Per','jobbank'); ?></label>
					<div class="col-md-1">									
						<input type="text" class="form-control" id="package_recurring_cycle_count" name="package_recurring_cycle_count" placeholder="<?php esc_html_e('Cycle #','jobbank');?>">
					</div>
					<div class="col-md-2">
						<select name="package_recurring_cycle_type" id ="package_recurring_cycle_type" class="ctrl-combobox form-control">											
							<option value="day"><?php esc_html_e('Day(s)','jobbank');?></option>
							<option value="week"><?php esc_html_e('Week(s)','jobbank');?></option>
							<option value="month"><?php esc_html_e('Month(s)','jobbank');?></option>
							<option value="year"><?php esc_html_e('Year(s)','jobbank');?></option>
						</select>		
					</div>
					<div class='col-md-12'><label for="text" class="col-md-2 control-label"></label>
				...
				<?php
					...
					<div class="form-group row">
						...
						<div class="col-md-6 ">
							<label>
								<input type="checkbox" name="package_enable_trial_period" id="package_enable_trial_period"  value='yes'> <?php  esc_html_e('Enable Trial Period','jobbank'); ?>
							</label>
							<br/>
					...
					<div id="trial_block" class="none" >
						<div class="form-group row">
							...
							<div class="col-md-6">
								<input type="text" class="form-control" id="package_trial_amount" name="package_trial_amount" placeholder="<?php esc_attr_e('Enter Amount to Bill for The Trial Period','jobbank');?>">
			...
			<div class="form-group row">
				...
				<div class="col-md-6 ">
					<p><hr></p>
					<div id="loading"></div>
					<button class="btn btn-info mt-2" onclick="return jobbank_save_the_package();"><?php  esc_html_e('Save Package','jobbank'); ?></button>
